...
import com.erp.car.report.entities.MaterialInitialStockWithMaterial;
import com.erp.car.report.entities.MaterialVo4Unit;
...
public interface MaterialMapperEx {
    ...
    String selectMaterialPickupName(@Param("id") Long id);
}
