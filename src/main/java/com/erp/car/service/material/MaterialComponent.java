...
import com.erp.car.service.ICommonQuery;
import com.erp.car.utils.Constants;
import com.erp.car.utils.QueryUtils;
...
public class MaterialComponent implements ICommonQuery {
    ...
    private List<?> getMaterialList(Map<String, String> map) throws Exception{
        ...
        return materialService.select(materialParam, color, materialOther, weight, expiryNum,
                enableSerialNumber, enableBatchNumber, enabled, remark, categoryId, mpList, organId, QueryUtils.offset(map), QueryUtils.rows(map));
    }
