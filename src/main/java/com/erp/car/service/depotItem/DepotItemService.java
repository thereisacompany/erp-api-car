...
import com.erp.car.report.mappers.*;
import com.erp.car.report.vo.DepotItemStockWarningCount;
import com.erp.car.report.vo.DepotItemVo4Stock;
import com.erp.car.report.vo.DepotItemVoBatchNumberList;
...
import com.erp.car.service.materialExtend.MaterialExtendService;
import com.erp.car.service.role.RoleService;
import com.erp.car.service.serialNumber.SerialNumberService;
...
public class DepotItemService {
    ...
    public int findByAllCount(String materialParam, String beginTime, String endTime, Long organId)throws Exception {
        int result=0;
        try{
            result = depotItemMapperEx.findByAllCount(materialParam, beginTime, endTime, organId);
        }catch(Exception e){
            JshException.readFail(logger, e);
        }
        return result;
...
//            }
    ...
    public BigDecimal getStockByParamWithDepot(List<Long> depotList, Long depotId, Long mId, String beginTime, String endTime, Long organId) {
        //初始库存
        BigDecimal initStock = materialService.getInitStockByMidAndDepotList(depotList, mId);
     ...
     * @return
     */
    public Map<String, BigDecimal> getIntervalMapByParamWithDepotList(List<Long> depotList, Long depotId, Long mId,
