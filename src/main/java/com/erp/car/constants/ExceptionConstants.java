...
public class ExceptionConstants {
    ...
    public static final String MATERIAL_EXTENSION_ERROR_MSG = "抱歉，文件檔案格式須為xls";
    //名称为空
    ...
    public static final String DEPOT_HEAD_NUMBER_NEED_EDIT_FAILED_MSG = "商品品號:%s的數量不足";
    //单据录入-商品的批号不能为空
     ...
     * type = 120
     */
    public static final int VEHICLE_NO_EXIST_CODE = 12000000;
